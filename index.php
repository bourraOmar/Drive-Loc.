<?php
require_once __DIR__ . '/../Drive-Loc/classes/vehicle.php';
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <?php if (isset($_SESSION["role_id"])) { ?>
                        <div>
                            <a href="../Drive-Loc/profils/client.php"><img width="25px" class="bg-white rounded-full shadow-soft" src="../Drive-Loc/img/profile-major.svg" alt="Profile"></a>
                        </div>
                    <?php } else { ?>
                        <div class="hidden md:flex items-center space-x-3">
                            <a href="../Drive-Loc/authentification/login.php" class="text-white hover:bg-blue-700 bg-blue-600 font-medium rounded-lg text-sm px-4 py-2 transition-all">Log In</a>
                            <a href="../Drive-Loc/authentification/signUp.php" class="text-blue-600 bg-white hover:text-blue-700 font-medium rounded-lg text-sm px-4 py-2 transition-all">Sign Up</a>
                        </div>
                    <?php } ?>
                </div>
            </div>
    ...
    <div class="bg-gray-50 py-12">
        ...
        <div class="flex justify-center m-4">
            <button class="bg-gradient-primary text-white px-4 py-2 rounded hover:bg-gradient-primary transition-all">
                <?php if (isset($_SESSION['role_id'])) { ?>
                    <a href="../Drive-Loc/pages/menu.php">Voir plus</a>
                <?php } else { ?>
